        ...
        <div className="dashboard-grid mt-40">
          ...
          <div className="card">
            <div className="card-header">
              ...
              <div className="dropdown">Last Month ↓</div>
            </div>
                ...
                <div className="revenue-stats">
                  ...
                  <div className="revenue-breakdown">
                    <div className="breakdown-item">
                      ...
                      <span>Online</span>
                      <strong>
                        {formatCurrency(revenueStats.onlineRevenue)}
                      </strong>
                    </div>
                    <div className="breakdown-item">
                      ...
                      <span>Cash</span>
                      <strong>
                        {formatCurrency(revenueStats.cashRevenue)}
                      </strong>
                    </div>
                  </div>
                </div>
                ...
                return (
                  <React.Fragment key={order._id}>
                    ...
                    >
                      ...
                      <td>{order.phone}</td>
                      <td>
                        {order.streetAddress}, {order?.pincode}
                      </td>
                        ...
                        <td colSpan={7}>
                          <div className="expanded-content">
                            ...
                            {/* <button
                              type="button"
                              onClick={() =>
                                markAsComplete(order._id as string)
                              }
                              className="w-auto flex justify-center font-medium text-white bg-dark py-2 px-3 text-sm rounded-lg ease-out duration-200 hover:bg-blue mt-5"
                            >
                              Mark as Complete
